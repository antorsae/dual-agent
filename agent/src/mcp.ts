...
import { runCodex, TaskType } from "./codex.js";
...
const TOOLS = [
  {
    ...
    description:
      "Delegate code review to Codex CLI. Use for security audits, bug finding, performance analysis, and thorough code quality checks. Spawns codex directly.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Delegate implementation to Codex CLI. Use for complex features, algorithms, or when meticulous edge-case handling is needed. Spawns codex directly.",
    inputSchema: {
      type: "object" as const,
      properties: {
        prompt: {
  ...
  },
  {
    ...
    description:
      "Delegate plan review to Codex CLI. Use to validate implementation plans, find gaps, and get architectural feedback. Spawns codex directly.",
    inputSchema: {
      type: "object" as const,
      properties: {
        plan: {
  ...
  },
  {
    name: "delegate_codex",
    description:
      "Send any prompt to Codex CLI. Use for custom tasks. Spawns codex directly without tmux or file communication.",
    inputSchema: {
      type: "object" as const,
      properties: {
        prompt: {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  switch (name) {
    ...
    case "delegate_codex_plan_review":
      ...
      prompt = (args as { plan: string }).plan;
      break;
